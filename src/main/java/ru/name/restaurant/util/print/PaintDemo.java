...
public class PaintDemo extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        int w=350,h=50;
        Rectangle rect2 = new Rectangle(40, 20, w, h + (tables.size() * 25));
        g2d.draw(rect2);
        rect2 = new Rectangle(40, 20, w, 40);
        g2d.draw(rect2);
        g2d.setFont(new Font("Courier", Font.BOLD, 20));
        g2d.drawString("Сальвадор", ((40 + w) / 2) - "Сальвадор".length(), 45);
        int i = 1;
        double payment = 0;
        for (Table t : tables) {
            payment += t.getPrice();
            ...
            g2d.drawString(t.getPrice() + "*" + t.getKol(), w, 45 + (i * 25 + 10));
            i++;
        }
        //TODO вывод цены
        rect2 = new Rectangle(40, 20 + 50 + (tables.size() * 25), w, 50);
